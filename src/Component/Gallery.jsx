    ...
    <>
      <div className='container'>
        ...
        <Row style={{ justifyContent: "space-between" }}>
          <Col >
            <img style={{ borderRadius: "10px", width: "800px", height: "450px" }} src={img1} />
          </Col>
          <Col style={{ textAlign: "end", width: "100%", }}>
            <img src={img2} b width={450} height={450} style={{ borderRadius: "10px" }} />
          </Col>
        </Row>

        <Row style={{ marginTop: "30px" }}>
          <Col>
            <img src={img6} height={370} width={500} style={{ borderRadius: "10px" }} />
          </Col>
          <Col>
            <img src={img4} height={370} width={700} style={{ borderRadius: "10px" }} />
          </Col>
        </Row>
        ...
        <div style={{ marginTop: "80px", justifyContent: "space-between" }}>
          <Row>
            <Col>
              <img src={img3} height={350} width={400} style={{ borderRadius: "10px" }} />
            </Col>
            <Col>
              <img src={img5} height={350} width={400} style={{ borderRadius: "10px" }} />
            </Col>
            <Col>
              <img src={img7} height={350} width={400} style={{ borderRadius: "10px" }} />
            </Col>
          </Row>
        </div>
